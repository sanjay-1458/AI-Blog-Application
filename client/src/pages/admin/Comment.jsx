...
function Comment() {
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      <div className='flex justify-between items-center md:max-w-5xl max-w-3xl'>
        <h1>Comments</h1>
      ...
      <div className='relative h-4/5 md:max-w-5xl max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-lg scrollbar-hide'>
